...
/******/ 	var hotCurrentHash = "faed7efd86d169bf4d72"; // eslint-disable-line no-unused-vars
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return APPKEY_TEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return APPSECRET_TEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return PID_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return LAB_TYPE_GRADE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return PID_VALUE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return MESSAGE_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return GLOBAL_HOST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return GLOBAL_DOCURL; });
var APPKEY_TEST = '111';
var APPSECRET_TEST = 'weqwew';
var PID_TYPE = {
    PHYSICAL1: 'PHYSICAL1',
    PHYSICAL2: 'PHYSICAL2',
    CHEMICAL1: 'CHEMICAL1',
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getServerData;
 ...
 * @returns {*}
 */
function getServerData(uniqueId, nickname, pidScope) {
  const timestamp = new Date().getTime().toString().substring(0, 10);
  const sign = __WEBPACK_IMPORTED_MODULE_0_blueimp_md5__(SECRET_DATA.appKey + SECRET_DATA.appSecret + nickname + pidScope + timestamp + uniqueId + '0');
  return {
    timestamp,
    sign
  };
...
class main {
    ...
    constructor() {
        this.labSDK = new __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["a" /* LabSDK */]();
        /** ************************************************************
         *                              账户信息
         ************************************************************* */
        // 需传入信息
        this.uniqueId = 'yiqitest3'; // 用户账户,必填
        ...
        this.pidType = __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].PHYSICAL1; // 产品标识,nobook提供
        /** ************************************************************
         *                              第一步: 页面加载完成初始化
         ************************************************************* */
        $(() => {
            ...
            if (this.labSDK.DEBUG) {
                __WEBPACK_IMPORTED_MODULE_2__server__["a" /* SECRET_DATA */].appKey = __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["c" /* APPKEY_TEST */];
                __WEBPACK_IMPORTED_MODULE_2__server__["a" /* SECRET_DATA */].appSecret = __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["d" /* APPSECRET_TEST */];
                this.labSDK.appKey = __WEBPACK_IMPORTED_MODULE_2__server__["a" /* SECRET_DATA */].appKey;
            }
            // ------------nobook内部测试用end------------//
            this.login();
        });
    ...
    login() {
        ...
        const { timestamp, sign } = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__server__["b" /* getServerData */])(this.uniqueId, this.nickname, pidScope);
        this.labSDK.login({
    ...
    init() {
        // 刷新左右侧列表
        this.freshList();
        this.labSDK.addListener(__WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["e" /* MESSAGE_TYPE */].ON_LOAD, event => {
            // 编辑器或播放器实验场景初始化成功时触发
            console.log('******************页面加载完成!!!');
        });
        this.showType(1);
    ...
    freshSubjectBtn() {
        ...
        const arr = [['初中物理', __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].PHYSICAL1], ['高中物理', __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].PHYSICAL2], ['初中化学', __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].CHEMICAL1], ['高中化学', __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].CHEMICAL2], ['初中生物', __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].BIOLOGICAL1], ['高中生物', __WEBPACK_IMPORTED_MODULE_1__nobook_nobook_saas_sdk_nobook_lab__["b" /* PID_TYPE */].BIOLOGICAL2]];
